...
Folders use "/" to separate levels.

Another technical name for Folder is **Directory**.
...
We will follow the following naming conventions in our development:

- Template(project) Folder: lowercase with hypens (e.g., ice-cream-template-1.21.1)
> Project Folder's name is automatically generated by the template for readability; 
> in fact, we don't use any hypens in actual coding.

- **Files/Classes** : PascalCase (e.g., ModItems.java)
